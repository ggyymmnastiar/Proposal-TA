...
Menguraikan teori-teori yang relevan, penelitian terdahulu, serta landasan konseptual mengenai analisis sentimen, klasifikasi teks, dan penerapan NLP.

\vspace{0.5em}
\noindent\textbf{Bab III Metodologi Penelitian} \\
Menjelaskan rancangan penelitian, tahapan pengumpulan data, metode analisis, serta model NLP yang digunakan.

\vspace{0.5em}
\noindent\textbf{Bab IV Hasil dan Pembahasan} \\
Menyajikan hasil eksperimen, evaluasi model, dan pembahasan hasil analisis.
